...
//    }
	...
	public static void main(String[] args) {
		...
		for (String str : s) {
			...
			// Getting the city name and adding it to a List
			List<String> cities = new ArrayList<>();
			while (matchCity.find()) {
				 System.out.println("Found city: " + matchCity.group());
				 //cities.add(matchCity.group()); 
			}
...
//		
//		// Getting the month
//		Pattern month = Pattern.compile("(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)", Pattern.CASE_INSENSITIVE);
//		Matcher matchMonth = month.matcher(data);
//		while (matchMonth.find()) {
//			//System.out.println(matchMonth.group());
//		}
//		
//		
//		// Getting the rai data
//		Pattern rainData = Pattern.compile("[0-9]+.[^,]", Pattern.CASE_INSENSITIVE);
//		Matcher matchRainData = rainData.matcher(data);
//		while (matchRainData.find()) {
//			System.out.println(matchRainData.group());
//		}
	}
